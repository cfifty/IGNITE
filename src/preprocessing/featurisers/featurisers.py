    ...
    def featurise(self, atom: Atom) -> np.ndarray:
        ...
        if self._encode_as_onehot:
            ...
            try:
                ...
                print(f'{atom} has too many radical electrons for featurizer. Overloading last index to represent '
                      f'multiple radicals (i.e. many electron radicals => same one-hot index).')
                features[-1] = 1.0
